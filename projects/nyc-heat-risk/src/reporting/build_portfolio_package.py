...
def write_evidence_pack(metadata: dict[str, Any], output: Path) -> None:
    ...
    lines = [
        ...
        "## Fast Proof Order",
        "",
        "1. Run the local proof: `make -C /Users/omer/aws-analytics-pipeline/projects/nyc-heat-risk demo-proof`",
        ...
        "5. Show final audit: `make -C /Users/omer/aws-analytics-pipeline/projects/nyc-heat-risk final-audit`.",
        "",
