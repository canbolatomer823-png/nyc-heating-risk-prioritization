...
def mask_arn_account_id(value: str) -> str:
    parts = value.split(":")
...
def audit_aws(items: list[AuditItem]) -> None:
    ...
    if env_values.get("AWS_ACCOUNT_ID") == "000000000000":
        ...
        add(items, "OK", "aws", "AWS account id", mask_account_id(env_values.get("AWS_ACCOUNT_ID", "")))
    if "000000000000" in env_values.get("IRSA_ROLE_ARN", ""):
        ...
        add(items, "OK", "aws", "IRSA role ARN", mask_arn_account_id(env_values.get("IRSA_ROLE_ARN", "")))
...
def audit_claim_scan(items: list[AuditItem]) -> None:
    scan_paths = [
        ...
        Path("/Users/omer/aws-analytics-pipeline/docs/nyc-heat-risk-final-rehearsal-pack.md"),
        Path("/Users/omer/aws-analytics-pipeline/docs/nyc-heat-risk-slide-script.md"),
        Path("/Users/omer/aws-analytics-pipeline/docs/nyc-heat-risk-slide-script-prova.md"),
    ]
