...
- [AWS_CONSOLE_STEPS.md](<project-root>/deploy/AWS_CONSOLE_STEPS.md)
...
- Repo içinde boş kalmaması için varsayılan bir [aws.env](<project-root>/deploy/aws.env) bıraktım.
...
- [AWS_ENV_SETUP.md](<project-root>/deploy/AWS_ENV_SETUP.md)
- [AWS_VALUES_GUIDE.md](<project-root>/deploy/AWS_VALUES_GUIDE.md)
- [FINAL_AWS_CHECKLIST.md](<project-root>/deploy/FINAL_AWS_CHECKLIST.md)
